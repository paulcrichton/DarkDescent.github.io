...
<html>
    ...
    <body>
        <div class="gameboy">
            ...
            <div class="item4">
                <span class='managment_button'><i class="fa fa-home"></i><a href="index.asp"> Start</a></span>
            </br>
            ...
            <div class="item5">
                <!-- Choice 1 -->
                <span class='choice_button'><a href="page2.asp">Choice 1</a></span>
                Follow the path
                </br>
                <!-- Choice 2 -->
                <hr class="line">
                <span class='choice_button'><a href="page3.asp">Choice 2</a></span>
                Give up
            </div>
        </div>
